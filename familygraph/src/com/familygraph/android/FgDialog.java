...
import com.familygraph.android.R;
import com.familygraph.android.FamilyGraph.DialogListener;

public class FgDialog extends Dialog {
    ...
    public FgDialog(Context context, String url, DialogListener listener) {
    ...
    private void setUpWebView(int margin) {
        ...
        mWebView.setWebViewClient(new FgDialog.FgWebViewClient());
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (url.startsWith(FamilyGraph.REDIRECT_URI)) {
                ...
                if (error == null) {
                    ...
                    mListener.onFamilyGraphError(new FamilyGraphError(error));
                }
